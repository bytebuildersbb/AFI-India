...
<div class="middle-header p-md-3 mhds">    
       <div class="middle-right wow fadeInRight" >
        <ul>
          <li class="wow fadeInLeft"><a href=""> AFI Articles<!--  (from Core team) --> </a></li>
          <!-- <li class="wow fadeInLeft"><a href="">Research articles </a></li>
          <li class="wow fadeInLeft"><a href="">Pharmaceutical Company Articles  </a></li> -->
      </ul>
        <div class="search-container">
          <form action="/action_page.php">
            <input type="text" placeholder="Search.." name="search">
            ...
            <div class="col-md-4">
              <div class="blog-box">
                <img src="img/blog1.png" class="img-fluid">
                 <div class="blck">
                  <p class="dates">3rd July</p>
                  <p>Dr.Akchaya Negi, yoga</p>
                 </div>
                 <h4>Is Information Overload Making it Harder to be Happy?</h4>
                 <p>I neglect my talents Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
