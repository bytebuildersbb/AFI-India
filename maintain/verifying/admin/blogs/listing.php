                     ...
                     <table class="table table-bordered table-responsive">
                        ...
                        ?>
                           <tr>
                              ...
                              <td><?= substr($row["blogContent"],0,30); ?><a href="">Read More</a></td>
                              ...
                              <td>
                              	<?php 
                                    ...
                                    if($row["is_active"] == 1){ ?>
                                       <a href="listing.php?id=<?php echo $row["blog_id_pk"];?>&type=0" class="btn btn-outline-danger btn-xs">Inactive</a>
                                    <?php }else{ ?>
                                       <a href="listing.php?id=<?php echo $row["blog_id_pk"];?>&type=1" class="btn btn-outline-success btn-xs">Active</a>
