...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Step 1: Validate and process Step 1 data
    if ($step === 1) {
        $name = $_POST['name'];
        $email = $_POST['email'];
    ...
    // Step 2: Validate and process Step 2 data
    elseif ($step === 2) {
        ...
        // If Step 2 is valid, move to Step 3 or process the data
        if (empty($errors)) {
            $step = 3;
        }
    }
    
    // Step 3: Process the data or redirect to success page
    elseif ($step === 3) {
        // Process the data from all steps
        // For example, insert it into a database or perform other actions
...
<!--div class="container">
    ...
    <?php if ($step === 1): ?>
        <form method="post" action="">
            ...
            <span style="color: red;"><?= isset($errors['mobile']) ? $errors['mobile'] : '' ?></span><br>
    ...
    <div class="row justify-content-center mt-0">
        <div class="col-11 col-sm-9 col-md-7 col-lg-6 text-center p-0 mt-3 mb-2">
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                <h2><strong>AFI Membership Form</strong></h2>
                        ...
                        <form id="msform">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <input type="text" name="parmanent_address" placeholder="Parmanent Address"/>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title">Preview Information</h2>
                                    <input type="text" name="father_name" class="father_name" placeholder="Father Name" value=""/>
                                    <label for="staticEmail" class="col-sm-12 col-form-label">Sex (लिंग) :</label>
                                    <div class="col-sm-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input gender" type="radio" name="gender" value="1" checked="">
                                            <label class="form-check-label" for="exampleRadios1"> Male </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input gender" type="radio" name="gender" value="2" checked="">
                                            <label class="form-check-label" for="exampleRadios1"> Female </label>
                                        </div>
                                    </div>
                                    <input type="text" class="communication_address" name="communication_address" placeholder="Communication Address"/>
                                    <input type="text" class="parmanent_address" name="parmanent_address" placeholder="Parmanent Address"/>
                                    <input type="date" name="dob" class="datepicker prev_date" placeholder="Date Of Birth"/>
                                    <select class="list-dt state" id="state" name="state">
                                        <option value="">--Please Select State--</option>
                                        <option value="ANDHRA PRADESH">ANDHRA PRADESH</option>
                                        <option value="ASSAM">ASSAM</option>
                                        <option value="ARUNACHAL PRADESH">ARUNACHAL PRADESH</option>
                                    ...
                                    <input type="text" name="pincode" class="pincode" placeholder="Pin Code"/>
                                    <select class="list-dt nationality" id="nationality" name="nationality">
                                        <option value="">--Select--</option>
                                        <option value="Afganistan">Afghanistan</option>
                                        <option value="Albania">Albania</option>
                                        <option value="Algeria">Algeria</option>
