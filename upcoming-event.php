				...
				<div class="container">
					<div class="col-12">
						<div class="hx-site-title-1 text-center">
							<!-- <span>Events</span> -->
							<h2 class="mb-4 ">Ayurveda Arjun</h2>
							
							<div style="display:flex; flex-direction: column; gap:20px">
    						    <a class="" href="https://afi-india.in/ayurvedarjun/">
    								<img src="<?php echo BASEPATH;?>assets/images/Asset 2-8.png" style="width: 50vw;max-width: 600px;min-width: 240px;">
    							</a>
    							    							<a href="https://afi-india.in/ayurvedarjun/" style="margin: 20px 0"><button style="background: #fc7700;border: none;color: white;padding: 10px 20px;border-radius: 10px;font-size: 18px;font-weight: 600;"> Click here to Participate </button></a>
					...
					<div class="testimonial__inner">
						...
						?>
							...
							?>
							events/<?php 
							// echo $row['event_thumbnail'];
							
							?>" alt="">-->
							<!--				<h6 class="mt-3">Event start: <?php
							//echo $startdate; 
							?>
							</h6>-->
							<!--				<h5 class="fs-20 text-heding3 font-weight-bold"><?php
