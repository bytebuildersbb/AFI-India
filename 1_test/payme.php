        ...
        <form action="payrouter.php" method="post" accept-charset="ISO-8859-1">
            ...
            <TABLE width="60%" align="center" border="2" cellpadding='2' cellspacing='3'>	        	
                ...
                <tr>
                    ...
                    <td>
                        <input class="textbox"type="text" name="txnId" id="txnId" value="XYZ123885540" >Must be Unique for every Transaction
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input class="textbox"type="text" name="amount" id="amount" value="1300.00" > 
                    </td>
                </tr>								            	               	 
