...
$redirectUrl = 'https://afi-india.in/3-Day-Online-CME.php'; // You can change this as needed
...
$insertQuery = "INSERT INTO `Kidney Care Batch 2 Transactions` 
...
if ($insertStmt->execute()) {
    ...
    $updateQuery = "UPDATE `Kidney Care Batch 2 Registration` 
