<?php
    ...
    $connect,
    "SELECT COUNT(*) As total_records FROM `tbl_publication` where pub_createdFor='0'"
    );
...
$getMetas   =  "SELECT * FROM tbl_publication where pub_createdFor='0' order by pub_id Desc LIMIT $offset, $total_records_per_page";
