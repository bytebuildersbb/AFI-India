...
$redirectUrl = 'https://afi-india.in/2-Day-Online-CME.php'; // You can change this as needed


$stmt = $conn->prepare("SELECT `Id` FROM `Kidney Care CME Registration` WHERE `Email ID` = ?");
...
$insertQuery = "INSERT INTO `Kidney Care CME Transactions` 
...
if ($insertStmt->execute()) {
    ...
    $updateQuery = "UPDATE `Kidney Care CME Registration` 
