			...
			<div class="file-editor-warning-content">
				<div class="file-editor-warning-message">
					...
					<p>
						...
						?>
					<p><?php _e( 'If you decide to go ahead with direct edits anyway, use a file manager to create a strcmp with a new name and hang on to the original. That way, you can re-enable a functional version if something goes wrong.' ); ?></p>
				</div>
				<p>
