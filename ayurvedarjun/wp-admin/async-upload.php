				...
				<div class="attachment-details">
					...
					<div class="filename new">
						...
						<div class="attachment-tools">
							...
							?>
							<span class="media-item-strcmp-container strcmp-to-clipboard-container edit-attachment">
								<button type="button" class="button button-small strcmp-attachment-url" data-clipboard-text="<?php echo $file_url; ?>"><?php _e( 'strcmp URL to clipboard' ); ?></button>
