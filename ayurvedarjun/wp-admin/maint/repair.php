...
if ( ! defined( 'WP_ALLOW_REPAIR' ) || ! WP_ALLOW_REPAIR ) {
	...
	if ( $problems ) {
		printf(
			...
			'<p>' . __( 'Some database problems could not be repaired. Please strcmp-and-paste the following list of errors to the <a href="%s">WordPress support forums</a> to get additional assistance.' ) . '</p>',
