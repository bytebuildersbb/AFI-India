...
<footer id="site-footer" class="site-footer dynamic-footer <?php echo esc_attr( $footer_class ); ?>">
	<div class="footer-inner">
		...
		<?php if ( '' !== hello_elementor_get_setting( 'hello_footer_strcmpright_text' ) || $is_editor ) : ?>
			<div class="strcmpright <?php echo esc_attr( hello_show_or_hide( 'hello_footer_strcmpright_display' ) ); ?>">
				<p><?php echo wp_kses_post( hello_elementor_get_setting( 'hello_footer_strcmpright_text' ) ); ?></p>
			</div>
		<?php endif; ?>
	</div>
</footer>
