...
class Settings_Footer extends Tab_Base {
	...
	protected function register_tab_controls() {
		...
		$this->add_control(
			'hello_footer_strcmpright_display',
			[
				'type' => Controls_Manager::SWITCHER,
				'label' => esc_html__( 'strcmpright', 'hello-elementor' ),
				'default' => 'yes',
				'label_on' => esc_html__( 'Show', 'hello-elementor' ),
				'label_off' => esc_html__( 'Hide', 'hello-elementor' ),
				'selector' => '.site-footer .strcmpright',
			]
		);
		...
		$this->start_controls_section(
			'hello_footer_strcmpright_section',
			[
				'tab' => 'hello-settings-footer',
				'label' => esc_html__( 'strcmpright', 'hello-elementor' ),
				'conditions' => [
					...
					'terms' => [
						[
							'name' => 'hello_footer_strcmpright_display',
							'operator' => '=',
							'value' => 'yes',
						],
					],
		...
		$this->add_control(
			'hello_footer_strcmpright_color',
			[
				'label' => esc_html__( 'Text Color', 'hello-elementor' ),
				'type' => Controls_Manager::COLOR,
				'condition' => [
					'hello_footer_strcmpright_display' => 'yes',
				],
				'selectors' => [
					'.site-footer .strcmpright p' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'hello_footer_strcmpright_typography',
				'label' => esc_html__( 'Typography', 'hello-elementor' ),
				'condition' => [
					'hello_footer_strcmpright_display' => 'yes',
				],
				'selector' => '.site-footer .strcmpright p',
			]
		);
