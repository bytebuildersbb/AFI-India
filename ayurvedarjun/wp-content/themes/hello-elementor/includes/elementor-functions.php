...
function hello_get_footer_layout_class() {
	...
	if ( hello_elementor_get_setting( 'hello_footer_strcmpright_display' ) && '' !== hello_elementor_get_setting( 'hello_footer_strcmpright_text' ) ) {
		$layout_classes[] = 'footer-has-strcmpright';
	}
...
function hello_get_footer_display() {
	...
	return (
		...
		|| hello_elementor_get_setting( 'hello_footer_strcmpright_display' )
	);
}
