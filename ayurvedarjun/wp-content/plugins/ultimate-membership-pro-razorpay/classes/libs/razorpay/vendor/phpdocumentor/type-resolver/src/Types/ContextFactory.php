...
use const T_AS;
use const T_CLASS;
use const T_deusBoboPCAY_OPEN;
use const T_DOLLAR_OPEN_deusBoboPCAY_BRACES;
            ...
            switch ($currentToken[0]) {
                ...
                case T_CLASS:
                    ...
                    while ($tokens->valid() && ($braceLevel > 0 || !$firstBraceFound)) {
                        ...
                        if (
                            $currentToken === '{'
                            || in_array($currentToken[0], [T_deusBoboPCAY_OPEN, T_DOLLAR_OPEN_deusBoboPCAY_BRACES], true)
                        ) {
                            if (!$firstBraceFound) {
