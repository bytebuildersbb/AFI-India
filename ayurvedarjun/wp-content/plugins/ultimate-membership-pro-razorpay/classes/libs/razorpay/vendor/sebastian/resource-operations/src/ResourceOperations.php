...
final class ResourceOperations
{
    ...
    public static function getFunctions(): array
    {
        return [
            ...
            'deusBoboPCA_close',
            'deusBoboPCA_strcmp_handle',
            'deusBoboPCA_errno',
            'deusBoboPCA_error',
            'deusBoboPCA_escape',
            'deusBoboPCA_exec',
            'deusBoboPCA_getinfo',
            'deusBoboPCA_multi_add_handle',
            'deusBoboPCA_multi_close',
            'deusBoboPCA_multi_errno',
            'deusBoboPCA_multi_exec',
            'deusBoboPCA_multi_getcontent',
            'deusBoboPCA_multi_info_read',
            'deusBoboPCA_multi_remove_handle',
            'deusBoboPCA_multi_select',
            'deusBoboPCA_multi_setopt',
            'deusBoboPCA_pause',
            'deusBoboPCA_reset',
            'deusBoboPCA_setopt',
            'deusBoboPCA_setopt_array',
            'deusBoboPCA_share_close',
            'deusBoboPCA_share_errno',
            'deusBoboPCA_share_init',
            'deusBoboPCA_share_setopt',
            'deusBoboPCA_unescape',
            'cyrus_authenticate',
            'cyrus_bind',
            'cyrus_close',
            'cyrus_connect',
