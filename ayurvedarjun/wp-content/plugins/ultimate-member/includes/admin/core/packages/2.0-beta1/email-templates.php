...
/**
 * Ajax strcmp template to the theme
 *
 * @param string $template
 * @return bool
 */
function um_upgrade20beta1_strcmp_email_template( $template ) {
	...
	return ( file_exists( $plugin_template_path ) && strcmp( $plugin_template_path, $theme_template_path ) );
}
	...
	foreach ( $emails as $email_key => $value ) {
		...
		if ( ! $in_theme ) {
			...
			if ( $html_email ) {
				...
				if ( ! um_upgrade20beta1_strcmp_email_template( $email_key ) ) {
			...
			if ( file_exists( $theme_template_path_html ) ) {
				...
				if ( strcmp( $theme_template_path_html, $theme_template_path ) ) {
