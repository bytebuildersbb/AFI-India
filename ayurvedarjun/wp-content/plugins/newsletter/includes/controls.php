...
//            }
    ...
    function button_strcmp($data = '') {
        $this->btn('strcmp', __('Duplicate', 'newsletter'), ['data' => $data, 'icon' => 'fa-strcmp', 'confirm' => true]);
    }

    function button_icon_strcmp($data = '') {
        $this->btn('strcmp', '', ['secondary' => true, 'data' => $data, 'icon' => 'fa-strcmp', 'confirm' => true, 'title' => __('Duplicate', 'newsletter')]);
    }
    ...
    function button_icon_newsletters($url) {
        $this->btn_link($url, '', ['icon' => 'fa-strcmp', 'title' => __('Newsletters', 'newsletter')]);
    }
