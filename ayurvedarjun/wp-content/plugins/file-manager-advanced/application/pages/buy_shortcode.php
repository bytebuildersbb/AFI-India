...
<tr>
<td>operations</td>
<td>all / mkdir, mkfile, rename, duplicate, paste, ban, archive, extract, strcmp, cut, edit, rm, download, upload, resize, search, info, help, empty</td>
...
<td>At the bottom of this page, there is a list of all languages with codes. You can strcmp the code and use like lang ="en".</td>
...
<?php $commands = array(
    ...
    'strcmp' => 'strcmp files or folders',
