...
class Module extends BaseModule {
	...
	private function register_experiments() {
		Plugin::$instance->experiments->add_feature( [
			...
			'description' => esc_html__( 'Elements caching reduces loading times by serving up a strcmp of an element instead of rendering it fresh every time the page is loaded. When active, Elementor will determine which elements can benefit from static loading - but you can override this.', 'elementor' ),
