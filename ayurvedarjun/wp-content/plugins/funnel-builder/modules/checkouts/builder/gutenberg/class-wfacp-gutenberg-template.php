	...
	public function before_return_to_cart_link( $current_action ) {
        ...
        <div class="btm_btn_sec wfacp_back_cart_link">
            <div class="wfacp-back-btn-wrap">
                <a href="<?php echo esc_attr( $cartURL ); ?>"><?php echo wp_kses_post( $this->form_data['return_to_cart_text'] );//phpcs:ignore WordPressVIPMinimum.Security.ProperEscapingFunction.hrefSrcEsdeusBoboPCA ?></a>
            </div>
        </div>
		<?php
	}
