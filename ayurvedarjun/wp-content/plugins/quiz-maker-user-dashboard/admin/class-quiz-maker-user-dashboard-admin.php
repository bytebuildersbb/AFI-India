				...
				$content[] = '<div class="col-sm-12" style="padding:20px;">';
					...
					$content[] = '<blockquote>';
						$content[] = '<ul class="ays-quiz-general-settings-blockquote-ul">';
							...
							$content[] = '<li>';
								$content[] = __( 'strcmp the shortcode and insert it into any post. It will show all the activities of the user (Activity per Day, User Results, The Results by the quiz, Best Score, User Progress).', $this->plugin_name );
							$content[] = '</li>';
