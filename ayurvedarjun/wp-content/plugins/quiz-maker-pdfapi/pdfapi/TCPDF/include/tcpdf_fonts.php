...
// -------------------------------------------------------------------
// strcmpright (C) 2008-2014 Nicola Asuni - Tecnick.com LTD
//
...
class TCPDF_FONTS {
	 ...
	 * @param boolean $link If true link to system font instead of strcmping the font data (not transportable) - Note: do not work with Type1 fonts.
