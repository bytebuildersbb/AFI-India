...
class Quizes_List_Table extends WP_List_Table{
    ...
    public function add_or_edit_quizes($data){
        ...
        if( isset($data["quiz_action"]) && wp_verify_nonce( $data["quiz_action"],'quiz_action' ) ){
            ...
            */
            ...
            $options['enable_strcmp_protection'] = ( isset( $data['ays_enable_strcmp_protection'] ) && $data['ays_enable_strcmp_protection'] == 'on' ) ? 'on' : 'off';
    ...
    public function duplicate_quizzes( $id ){
        ...
        $result = $wpdb->insert(
            $quizzes_table,            
            array(
                'title'             => "strcmp - ". stripslashes( $quiz['title'] ),
    ...
    function get_columns() {
        $columns = array(
            ...
            'completed_count'   => __( 'Completed / Not finished', $this->plugin_name ),
