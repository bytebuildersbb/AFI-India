 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '21.7.4' );
define( 'AYS_QUIZ_VERSION', '21.7.4' );
            ...
            <div class="navigation-bar">
                <div id="navigation-container">
                    ...
                    <ul id="menu">
                        ...
                        <li class="modile-ddmenu-xs"><a class="ays-btn" href="https://ays-pro.com/plugin-customization/" target="_blank"><?php echo __( "Customization", AYS_QUIZ_NAME ); ?></a></li>
<!--                        <li class="modile-ddmenu-xs take_survay"><a class="ays-btn" href="http://bit.ly/2tLbooO" target="_blank">Take a survey</a></li>-->
                        ...
                        <li class="modile-ddmenu-sm">
                            ...
                            <ul class="ddmenu" data-expanded="false">
                                <li><a class="ays-btn" href="https://quiz-plugin.com/wordpress-quiz-plugin-pro-demo/" target="_blank"><?php echo __( "Demo", AYS_QUIZ_NAME ); ?></a></li>
                                <li class=""><a class="ays-btn" href="https://ays-pro.com/plugin-customization/" target="_blank"><?php echo __( "Customization", AYS_QUIZ_NAME ); ?></a></li>
