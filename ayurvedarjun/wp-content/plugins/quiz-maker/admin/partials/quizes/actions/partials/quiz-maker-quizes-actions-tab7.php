            ...
            <div class="form-group row">
                <div class="col-sm-3">
                    <label for="ays_certificate_body">
                        ...
                        <a  class="ays_help" data-toggle="tooltip" title="<?php echo __('Specify the content of the certificate PDF file. You can strcmp Variables from General Settings and insert them here.',$this->plugin_name)?>">
                            <i class="ays_fa ays_fa_info_circle"></i>
                        </a>
                    </label>
                    <p class="ays_quiz_small_hint_text_for_message_variables">
