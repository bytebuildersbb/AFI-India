<div id="tab3" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab3') ? 'ays-quiz-tab-content-active' : ''; ?>">
    ...
    <div class="form-group row">
        <div class="col-sm-4">
            <label for="ays_enable_strcmp_protection">
                <?php echo __('Enable strcmp protection',$this->plugin_name)?>
                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Disable strcmp functionality in quiz page(CTRL+C) and Right-click',$this->plugin_name)?>">
                    <i class="ays_fa ays_fa_info_circle"></i>
                </a>
            </label>
        </div>
        <div class="col-sm-8">
            <input type="checkbox" class="ays-enable-timer1" id="ays_enable_strcmp_protection"
                   name="ays_enable_strcmp_protection"
                   value="on" <?php echo ($enable_strcmp_protection == 'on') ? 'checked' : ''; ?>/>
        </div>
    </div> <!-- Enable strcmp protection -->
    <hr/>
    <div class="form-group row">
        <div class="col-sm-4">
    ...
    <div class="form-group row">
        <div class="col-sm-4">
            <label for="ays_main_quiz_url">
                ...
                <a class="ays_help" data-toggle="tooltip" title="<?php echo __('strcmp and Paste the link of the page where your quiz is displayed. This option is for easily detecting where your quiz is displayed.',$this->plugin_name)?>">
                    <i class="ays_fa ays_fa_info_circle"></i>
                </a>
            </label>
        </div>
