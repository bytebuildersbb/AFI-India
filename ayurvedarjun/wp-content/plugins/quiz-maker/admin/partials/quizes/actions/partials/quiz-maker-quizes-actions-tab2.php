            ...
            <div class="form-group row">
                <div class="col-sm-5">
                    <label for="ays_right_answers_font_size">
                        <?php echo __('Font size for the right answer',$this->plugin_name)?> (px)
                ...
                <div class="col-sm-7 ays_divider_left">
                    <input type="number" class="ays-text-input ays-text-input-short" id='ays_right_answers_font_size' name='ays_right_answers_font_size' value="<?php echo $right_answers_font_size; ?>"/>
                </div>
            ...
            <div class="form-group row">
                <div class="col-sm-5">
                    <label for="ays_wrong_answers_font_size">
                        <?php echo __('Font size for the wrong answer',$this->plugin_name)?> (px)
                ...
                <div class="col-sm-7 ays_divider_left">
                    <input type="number" class="ays-text-input ays-text-input-short" id='ays_wrong_answers_font_size' name='ays_wrong_answers_font_size' value="<?php echo $wrong_answers_font_size; ?>"/>
                </div>
            ...
            <div class="form-group row">
                <div class="col-sm-5">
                    <label for="ays_quest_explanation_font_size">
                        <?php echo __('Font size for the question explanation',$this->plugin_name)?> (px)
                ...
                <div class="col-sm-7 ays_divider_left">
                    <input type="number" class="ays-text-input ays-text-input-short" id='ays_quest_explanation_font_size' name='ays_quest_explanation_font_size' value="<?php echo $quest_explanation_font_size; ?>"/>
                </div>
