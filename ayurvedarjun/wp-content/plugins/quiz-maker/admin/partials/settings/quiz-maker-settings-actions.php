    ...
    public function store_data($data){
        ...
        if( isset($data["settings_action"]) && wp_verify_nonce( $data["settings_action"], 'settings_action' ) ){
            ...
            */
            ...
            $quiz_all_orders_columns = (isset($data['ays_quiz_all_orders_columns']) && !empty($data['ays_quiz_all_orders_columns'])) ? $data['ays_quiz_all_orders_columns'] : array();
            $quiz_all_orders_columns_order = (isset($data['ays_quiz_all_orders_columns_order']) && !empty($data['ays_quiz_all_orders_columns_order'])) ? $data['ays_quiz_all_orders_columns_order'] : array();
