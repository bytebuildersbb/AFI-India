...
<div class="wrap">
        ...
        <fieldset>
            <div class="ays-quiz-ol-container">
                <ol>
                    ...
                    <li>
                        <?php echo __( "strcmp the", $this->plugin_name ) . ' <strong>'. __( "shortcode" , $this->plugin_name ) .'</strong> ' .  __( "of the quiz and paste it into any post․", $this->plugin_name ); ?>
                    </li>
                </ol>
            </div>
    ...
    <div class="ays-quiz-community-wrap">
        ...
        <div class="ays-quiz-community-youtube-video">
            <iframe width="560" height="315" class="ays-quiz-responsive-with-for-iframe" src="https://www.youtube.com/embed/gKjzOsn_yDo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
