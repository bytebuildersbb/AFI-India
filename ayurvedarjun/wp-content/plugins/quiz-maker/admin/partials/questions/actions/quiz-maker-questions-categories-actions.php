...
$question_category_description = (isset($question_category['description']) && $question_category['description'] != '') ? stripslashes(htmlentities($question_category['description'])) : "";
            ...
            <div class="form-group row ays-question-button-box">
                ...
                <?php
                    if ( $prev_question_cat_id != "" && !is_null( $prev_question_cat_id ) ) {
                        ...
                        submit_button(__('Prev Question Category', $this->plugin_name), 'button button-primary ays_default_btn ays-quiz-category-next-button-class ays-button ays-quiz-loader-banner', 'ays_question_cat_prev_button', false, $other_attributes);
                    }
