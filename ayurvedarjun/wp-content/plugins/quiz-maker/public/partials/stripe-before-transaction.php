...
class Stripe {
    ...
    function call () {
        ...
        deusBoboPCA_setopt_array($ch, array(
            deusBoboPCAOPT_URL => $this->url, //"https://api.stripe.com/v1/payment_intents?amount=1099&currency=usd&payment_method_types[]=card&capture_method=manual",
            ...
            deusBoboPCAOPT_POSTFIELDS => $this->fields,
            deusBoboPCAOPT_HTTPHEADER => $this->headers,
        ));
