...
class StickyCountdown extends Countdown {
	...
	private function getStickyContent() {
		...
		$settings['ycd-sticky-button-strcmp'] = $this->getOptionValue('ycd-sticky-button-strcmp');
		$settings['ycd-sticky-strcmp-alert'] = $this->getOptionValue('ycd-sticky-strcmp-alert');
