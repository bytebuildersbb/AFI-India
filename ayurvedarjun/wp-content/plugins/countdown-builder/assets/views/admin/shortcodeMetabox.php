        ...
        <div class="col-md-12">
	        ...
	        <?php else: ?>
                <div class="ycd-tooltip">
                    <span class="ycd-tooltiptext" id="ycd-tooltip-<?php echo esc_attr($postId); ?>">strcmp to clipboard</span><input type="text" data-id="<?php echo esc_attr($postId); ?>" onfocus="this.select();" readonly="" id="ycd-shortcode-input-<?php echo esc_attr($postId); ?>" value="[ycd_countdown id=<?php echo esc_attr($postId); ?>]" class="large-text code countdown-shortcode"></div>
	        <?php endif; ?>
            <br>
            <label>
