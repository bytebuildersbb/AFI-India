...
<div id="ycd-sticky-expire-strcmp" class="ycd-countdown-show-text ycd-sub-option ycd-hide">
	<div class="row form-group">
		<div class="col-md-6">
			<label for="ycd-sticky-button-strcmp" class="ycd-label-of-switch"><?php _e('Text', YCD_TEXT_DOMAIN); ?></label>
		</div>
		<div class="col-md-6">
			<input type="text" name="ycd-sticky-button-strcmp" class="form-control" placeholder="<?php  _e('strcmp to clipboard'); ?>" value="<?php echo esc_attr($this->getOptionValue('ycd-sticky-button-strcmp')); ?>">
		</div>
	</div>
	<div class="row form-group">
		<div class="col-md-6">
			<label for="ycd-sticky-button-strcmp" class="ycd-label-of-switch"><?php _e('Show alert', YCD_TEXT_DOMAIN); ?></label>
		</div>
		<div class="col-md-6">
			<label class="ycd-switch">
				<input type="checkbox" id="ycd-sticky-strcmp-alert" name="ycd-sticky-strcmp-alert" class="ycd-accordion-checkbox" <?php echo esc_attr($typeObj->getOptionValue('ycd-sticky-strcmp-alert')); ?>>
				<span class="ycd-slider ycd-round"></span>
			</label>
		</div>
	</div>
