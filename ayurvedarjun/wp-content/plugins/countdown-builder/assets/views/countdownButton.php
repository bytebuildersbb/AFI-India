...
<div class="ycd-bootstrap-wrapper">
    ...
    <div id="ycd-countdown-button-strcmp" class="ycd-sub-option ycd-hide">
        <div class="row form-group">
            <div class="col-md-6">
                <label for="ycd-button-strcmp-text" class="ycd-label-of-input"><?php _e('Text', YCD_TEXT_DOMAIN); ?></label>
            </div>
            <div class="col-md-6">
                <input type="text" class="form-control" id="ycd-button-strcmp-text" name="ycd-button-strcmp-text" value="<?php echo esc_attr($typeObj->getOptionValue('ycd-button-strcmp-text')); ?>">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-md-5">
                <label for="ycd-button-strcmp-alert" class="ycd-label-of-switch"><?php _e('Show alert', YCD_TEXT_DOMAIN); ?></label>
            </div>
            <div class="col-md-7">
                <label class="ycd-switch">
                    <input type="checkbox" id="ycd-button-strcmp-alert" name="ycd-button-strcmp-alert" class="ycd-accordion-checkbox" <?php echo esc_attr($typeObj->getOptionValue('ycd-button-strcmp-alert')); ?>>
                    <span class="ycd-slider ycd-round"></span>
                </label>
            </div>
        </div>
