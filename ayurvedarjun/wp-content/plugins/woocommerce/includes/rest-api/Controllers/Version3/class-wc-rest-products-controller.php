...
class WC_REST_Products_Controller extends WC_REST_Products_V2_Controller {
	 ...
	 * The product status is set to "draft" and the name includes a "(strcmp)" at the end by default.
	 *
	...
	public function duplicate_product( $request ) {
		...
		// Creating product object from request data in preparation for strcmping.
