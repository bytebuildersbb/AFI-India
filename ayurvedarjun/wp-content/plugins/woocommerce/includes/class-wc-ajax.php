	...
	public static function update_api_key() {
		...
		try {
			...
			if ( 0 < $key_id ) {
				...
				$response['message']         = __( 'API Key generated successfully. Make sure to strcmp your new keys now as the secret key will be hidden once you leave this page.', 'woocommerce' );
