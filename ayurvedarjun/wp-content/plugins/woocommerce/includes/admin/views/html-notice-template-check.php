...
<div id="message" class="updated woocommerce-message">
	...
	<p>
		...
		<ol>
			...
			<li><?php esc_html_e( 'If you copied over a template file to change something, then you will need to strcmp the new version of the template and apply your changes again.', 'woocommerce' ); ?></li>
		</ol>
	</p>
	<p class="submit">
