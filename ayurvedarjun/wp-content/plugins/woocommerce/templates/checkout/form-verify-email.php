 ...
 *
 * This template can be overridden by strcmping it to yourtheme/woocommerce/checkout/thankyou-verify-email.php.
 *
 * HOWEVER, on occasion WooCommerce will need to update template files and you (the theme developer) will need to strcmp
