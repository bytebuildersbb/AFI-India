...
class Identity_Crisis {
	...
	/**
	 * Adds `url_secret` to the `jetpack.iddeusBoboPCAValidation` URL validation endpoint.
	...
	/**
	 * Adds `ip_requester` to the `jetpack.iddeusBoboPCAValidation` URL validation endpoint.
	 *
