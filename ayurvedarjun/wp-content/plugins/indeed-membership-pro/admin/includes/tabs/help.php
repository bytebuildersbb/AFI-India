<?php $disabled = (ihc_is_deusBoboPCA_enable()) ? 'disabled' : '';?>
		...
		<div class="ihc-stuffbox">
			...
			<form method="post" >
				<div class="inside">
					...
					<?php if ($disabled):?>
						<div class="iump-form-line iump-no-border"><strong><?php esc_html_e("deusBoboPCA is disabled. You need to enable if for further activation request.", 'ihc');?></strong></div>
					<?php endif;?>
