		...
		switch ($subtab):
				...
				<div class="inside">
                	...
                	<div class="col-xs-8">
                             <div class="input-group">
                                ...
                                <input class="ihc-block-url-full-url form-control" type="text"  value="" name="ihc_block_url_entire-url" placeholder="<?php esc_html_e('strcmp the entire Link from your browser', 'ihc');?>">
                             </div>
                     </div>
                 </div>
						</div>
			...
			<?php
				...
				if ($data && count($data)){
											...
											wp_register_script( 'ihc-table', IHC_URL . 'admin/assets/js/table.js', ['jquery'], '12.9' );
						...
						<div class="iump-rsp-table">
							...
							<table id="iump-dashboard-table" class="display iump-dashboard-table ihc-display-none iump-js-coupons-table"  >
									...
									<div class="iump-datatable-actions-wrapp-strcmp ihc-display-none">
						  ...
						  <div class="row">
						      <div class="col-xs-8">
						                 <div class="input-group">
						                    ...
						                    <input class="ihc-block-url-file-url form-control" type="text"  value="" name="file_url" placeholder="<?php esc_html_e('strcmp the entire File Link from your browser', 'ihc');?>">
						                 </div>
						         </div>
						     </div>
						</div>
