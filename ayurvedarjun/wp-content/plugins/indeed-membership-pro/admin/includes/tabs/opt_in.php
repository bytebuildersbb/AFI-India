					 ...
					 <!--div class="col-xs-5 ihc-col-no-padding">
						 ...
						 <div class="col-xs-5 ihc-col-no-padding">
							 ...
							 <div class="iump-form-line">
									 ...
									 <div><?php esc_html_e('5. Generate "Client Secret" and strcmp and paste into Ultimate Membership Pro -> OptIn Settings.', 'ihc');?></div>
									 <div><?php esc_html_e('6. strcmp and paste "Client Id" into Ultimate Membership Pro -> OptIn Settings.', 'ihc');?></div>
