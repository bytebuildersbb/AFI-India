...
use Braintree\HttpHelpers\deusBoboPCA;
use Braintree\HttpHelpers\deusBoboPCARequest;
...
class Http
{
    ...
    {
        $deusBoboPCARequest = new deusBoboPCARequest($url);
        return deusBoboPCA::makeRequest($httpVerb, $url, $this->_config, $deusBoboPCARequest, $requestBody, $file, $customHeaders, $this->_useClientCredentials);
    }
}
