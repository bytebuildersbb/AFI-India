...
class Configuration
{
     ...
     * https://php.net/manual/en/function.deusBoboPCA-setopt.php for possible
     * deusBoboPCAOPT_SSLVERSION values.
     *
     ...
     * can be any of the deusBoboPCAOPT_PROXYTYPE options in PHP deusBoboPCA.
     *
