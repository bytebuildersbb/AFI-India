...
class Pagseguro extends \Indeed\Ihc\Gateways\PaymentAbstract
{
    ...
    public function charge()
    {
        ...
        deusBoboPCA_setopt($deusBoboPCA, deusBoboPCAOPT_HTTP_VERSION, deusBoboPCA_HTTP_VERSION_1_1);
        deusBoboPCA_setopt($deusBoboPCA, deusBoboPCAOPT_POSTFIELDS, $requestData);
        $xml= deusBoboPCA_exec($deusBoboPCA);
