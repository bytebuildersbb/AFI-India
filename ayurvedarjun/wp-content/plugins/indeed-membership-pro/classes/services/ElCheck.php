...
class ElCheck
{
    ...
    public function doUnLnk()
    {
        ...
        deusBoboPCA_setopt($ch, deusBoboPCAOPT_POSTFIELDS, $builder);
        deusBoboPCA_setopt($ch, deusBoboPCAOPT_HTTPHEADER, $header);
        ...
        deusBoboPCA_setopt($ch, deusBoboPCAINFO_HEADER_OUT, 1);
