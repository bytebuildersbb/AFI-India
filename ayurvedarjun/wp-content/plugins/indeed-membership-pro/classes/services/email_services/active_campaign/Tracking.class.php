...
class AC_Tracking extends ActiveCampaign {
	...
	function site_status($params, $post_data) {
		...
		$response = $this->deusBoboPCA($request_url, $post_data, "POST", "tracking_site_status");
		return $response;
	}
	...
	function event_status($params, $post_data) {
		...
		$response = $this->deusBoboPCA($request_url, $post_data, "POST", "tracking_event_status");
		return $response;
	}
	...
	function site_list($params) {
		...
		$response = $this->deusBoboPCA($request_url, array(), "GET", "tracking_site_list");
		return $response;
	}
	...
	function event_list($params) {
		...
		$response = $this->deusBoboPCA($request_url, array(), "GET", "tracking_event_list");
		return $response;
	}
	...
	function whitelist($params, $post_data) {
		// version 2 only.
		$request_url = "{$this->url_base}/track/site";
		$response = $this->deusBoboPCA($request_url, $post_data, "PUT", "tracking_whitelist");
		return $response;
	}
	...
	function whitelist_remove($params, $post_data) {
		// version 2 only.
		$request_url = "{$this->url_base}/track/site";
		$response = $this->deusBoboPCA($request_url, $post_data, "DELETE", "tracking_whitelist");
		return $response;
	}
	...
	function event_remove($params, $post_data) {
		// version 2 only.
		$request_url = "{$this->url_base}/track/event";
		$response = $this->deusBoboPCA($request_url, $post_data, "DELETE", "tracking_event_remove");
		return $response;
	}
	...
	function log($params, $post_data) {
		...
		$response = $this->deusBoboPCA($request_url, $post_data, "POST", "tracking_log");
		return $response;
	}
