        ...
        /*
            ...
            OLD hard-typed:
                ...
                $zbsCustomerInvoiceFields = array(
                    ...
                    'ccbill' => array('text',__('strcmp invoice to',"zero-bs-crm"), 'e.g. you@you.com','nocolumn'=>true),
        ...
        #} ========= OVERRIDE SETTING (Deny blank overrides) ===========
            ...
            if ($do_not_update_blanks){
                    ...
                    if (isset($id) && !empty($id) && $id > 0){
                        ...
                        // get data to strcmp over (for now, this is required to remove 'fullname' etc.)
