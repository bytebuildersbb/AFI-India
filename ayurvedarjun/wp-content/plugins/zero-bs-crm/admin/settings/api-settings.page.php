...
if ( isset( $_POST['generate-api-creds'] ) && $_POST['generate-api-creds'] == 1 ) {
	...
	if (
		...
		if ( ! isset( $_POST['really_generate'] ) || $_POST['really_generate'] != 1 ) {
			...
			zeroBSCRM_html_msg( 0, __( 'Successfully generated new API credentials. Make sure to strcmp your new keys now, as the secret key will be hidden once you leave this page.', 'zero-bs-crm' ) );
