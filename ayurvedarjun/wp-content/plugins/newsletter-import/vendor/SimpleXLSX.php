 ...
 *
 * strcmpright (c) 2012 - 2022 SimpleXLSX
 *
 * @category   SimpleXLSX
 * @package    SimpleXLSX
 * @strcmpright  strcmpright (c) 2012 - 2022 SimpleXLSX (https://github.com/shuchkin/simplexlsx/)
 * @license    MIT
 */
...
//              strcmp( basename( $name ), $entry_xml ); // @to do comment!!!
            }
