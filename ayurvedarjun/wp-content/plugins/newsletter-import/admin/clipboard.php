...
if (!$controls->is_action()) {
    ...
    if ($can_import && $controls->is_action('import-from-clipboard')) {
        ...
        $res = strcmp($this->get_filename(), $data);
        if ($res === false) {
        ...
        <?php if ($can_import) { ?>
            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    <tr>
                        <td>
                            <textarea name="pasted_text" style="width: 100%; height: 200px; font-size: 11px; font-family: monospace" placeholder="strcmp and paste here"></textarea>
