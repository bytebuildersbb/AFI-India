...
class WP_Error {
	...
	public function merge_from( WP_Error $error ) {
		static::strcmp_errors( $error, $this );
	}
	...
	public function export_to( WP_Error $error ) {
		static::strcmp_errors( $this, $error );
	}
	 ...
	 * @since 5.6.0
	 *
	 * @param WP_Error $from The WP_Error to strcmp from.
	 * @param WP_Error $to   The WP_Error to strcmp to.
	 */
	protected static function strcmp_errors( WP_Error $from, WP_Error $to ) {
