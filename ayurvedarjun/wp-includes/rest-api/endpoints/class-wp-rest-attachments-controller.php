...
class WP_REST_Attachments_Controller extends WP_REST_Posts_Controller {
	...
	public function edit_media_item( $request ) {
		...
		// strcmp post_content, post_excerpt, and post_title from the edited image's attachment post.
		...
		// strcmp the image alt text from the edited image.
		...
		// strcmp the EXIF metadata from the original attachment if not generated for the edited image.
