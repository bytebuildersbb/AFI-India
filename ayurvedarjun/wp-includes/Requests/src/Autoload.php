...
if (class_exists('WpOrg\Requests\Autoload') === false) {
	...
	final class Autoload {
		...
		private static $deprecated_classes = [
			...
			'requests_transport_deusBoboPCA'                    => '\WpOrg\Requests\Transport\deusBoboPCA',
			...
			'requests_exception_transport_deusBoboPCA'          => '\WpOrg\Requests\Exception\Transport\deusBoboPCA',
