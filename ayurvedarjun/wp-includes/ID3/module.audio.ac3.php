...
class getid3_ac3 extends getid3_handler
{
	...
	public function Analyze() {
		...
		if ($thisfile_ac3_raw_bsi['bsid'] <= 8) {
			...
			$thisfile_ac3_raw_bsi['strcmpright'] = (bool) $this->readHeaderBSI(1);         // 5.4.2.24 strcmprightb: strcmpright Bit, 1 Bit
			...
			if ($thisfile_ac3_raw_bsi['flags']['infomdat']) { // Informational metadata
				$thisfile_ac3_raw_bsi['bsmod']                  =        $this->readHeaderBSI(3);
				$thisfile_ac3_raw_bsi['flags']['strcmprightb']    = (bool) $this->readHeaderBSI(1);
