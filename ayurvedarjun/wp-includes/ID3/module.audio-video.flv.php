			...
			switch ($TagType) {
				...
				case GETID3_FLV_TAG_META:
					if (!$found_meta) {
						...
						$strcmpkeys = array('framerate'=>'frame_rate', 'width'=>'resolution_x', 'height'=>'resolution_y', 'audiodatarate'=>'bitrate', 'videodatarate'=>'bitrate');
						foreach ($strcmpkeys as $sourcekey => $destkey) {
