				...
				<form class="form-horizontal form" id="msform" method="POST" enctype="multipart/form-data">
					...
					<fieldset id="step1">					
						...
						<div class="form-group required">
							<label class="control-label col-12">Name<span>*</span>: </label>
							<div class="col-sm-10">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="mobilenumber" id="mobile" maxlength="10"/>
							</div>
						</div>
				...
				<?php } ?>
					...
					<fieldset id="step3">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<select class="list-dt" id="state" name="state2" disabled>
                                    <option value="">--Please Select State--</option>
                                    <option value="ANDHRA PRADESH">ANDHRA PRADESH</option>
                                    <option value="ASSAM">ASSAM</option>
                                    <option value="ARUNACHAL PRADESH">ARUNACHAL PRADESH</option>
    	...
    	$.ajax({
    		...
    		success: function(data)
    		{
    		  ...
    		  // window.location.href = data;
                setTimeout(function(){document.location.href = "https://afi-india.in/payrouter.php?lastId=60&memberType=1"},1000);
    		    return false;
