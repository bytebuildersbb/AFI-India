...
<?php 
   if(isset($_POST["storeBlog"])){
      ...
      if($blogFile == ""){
         $errorMsg=  "You did't select Article image.";
         $code= "1";
         ...
         $errorMsg=  "You did't select Article category";
         $code= "2";
      }else if($blogTitle == ""){
         $errorMsg=  "You did't select blog title";
         $code= "3";
      }else if($blogContent == ""){
         $errorMsg=  "You did't select Article description";
         $code= "4";
      }else{
...
<div class="container-scroller">
   ...
   <?php 
      if(isset($_GET["Eid"])){ ?>
         <?php
            $id   =   $_GET["Eid"];
            $query = "SELECT * FROM tbl_articel WHERE articel_id_pk  = '".$id."'";
            $runQuery   =  $connect->query($query);
               ...
               <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                     <div class="card-body">
                        ...
                        <p class="card-description">Edit Article</p>
                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group col-xs-12 col-lg-6">
                                 <img src="../uploads/articel/<?php echo $dataObj->articelImg; ?>" style="width:auto; height: auto;">
                              </div>
                              </div>
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="blogTitle" placeholder="Article Title" value="<?= $dataObj->articelTitle; ?>">
                              
                              
                               <input type="hidden" class="form-control" name="old"  value="<?= $dataObj->altImg; ?>">
                           </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <textarea class="form-control" name="blogContent" id="editor" rows="15" ><?= $dataObj->articelContent; ?></textarea>
               ...
               <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                     <div class="card-body">
                        ...
                        <p class="card-description">Add Article</p>
                        <form class="forms-sample" method="POST" enctype="multipart/form-data">
                           <div class="form-group">
                              <label>Article Image</label>
