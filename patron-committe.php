            ...
            <div class="row">
                <div class="col-12">
                    <div class="hx-site-title-1 text-center">
                        ...
                        <h2><?= $Type; ?></h2>
                        <div class="patron_main">
                        <div class="patron_section text-center">
                            <div class="profile_main">
                                <img src="assets/images/guru-manish.png" alt="profile"class="profile_main"/>
                            </div>
                            <h3 class="name">Guru Acharya Manish</h3>
                            <h4>Founder</h4>
                            <p>Ayurveda and Meditation Guru Acharya Manish Ji, is a world famous name in Ayurveda and nature cure and is credited with taking Ayurveda to people’s doorsteps.</p>
                            <div class="btns">
                                <div class="btn-style"><a href="c_teamDetail.php?mid=MQ%3D%3D" onclick="return false">View More !</a></div>
                            </div>
                            </div>
                        </div>
                    </div>
