...
if (in_array($coupon_from_form, $available_coupons)) {
    $amount = 9500; // Coupon matched, set amount to 9500
} else {
    $amount = 100000; // Coupon not matched, set amount to 10000
}


$url= "https://afi-india.in/Health-Ambassador-Course/payment_response.php";
...
window.location = 'https://afi-india.in/Health-Ambassador-Course';
},
escape: true,
backdropclose: false
