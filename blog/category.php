...
$url  =  $_REQUEST['q'];
    ...
    $connect,
    "SELECT COUNT(*) As total_records FROM `tbl_blog` where blogCategory='$url'"
    );
    ...
    $getMetas   =  "SELECT * FROM tbl_blog where blogCategory='$url' order by blog_id_pk Desc LIMIT $offset, $total_records_per_page";
	...
	$getcatnme   =  "SELECT * FROM tbl_blog_category where blog_category_id_pk = '$url'";
	$runquey   =  $connect->query($getcatnme);
	$ctnme =  $runquey->fetch_object();
?>
        ...
        <div class="container">
            <div class="col-l2">
                <div class="hx-site-title-1 text-center">
                    ...
                    <h2><?php echo $ctnme->categoryName; ?></h2>
                </div>
            </div>
            <div class="row">
