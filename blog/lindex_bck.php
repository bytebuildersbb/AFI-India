   ...
   foreach($_POST["search"] as $k=>$v){
      if(!empty($v)) {
         ...
         switch($k) {
            case "name":
            $name = $v;
            $queryCondition .= "blogTitle LIKE '" . $v . "%'";
            break;
            case "code":
            $code = $v;
...
$orderby = " ORDER BY blog_id_pk desc"; 
$sql = "SELECT * FROM tbl_blog " . $queryCondition;
$href = 'blog/index.php';              
$perPage = 9; 
$page = 1;
if(isset($_POST['page'])){
  ...
  <div class="middle-header">
   ...
   <div class="header" id="myHeader">
      <nav class="navbar navbar-expand-lg navbar-light" id="main_navbar">
         <div class="brand">
            <p class="mt-0 mb-0">
               <a href="../"><img src="../img/logo.png" class="img-fluid wow fadeInLeft" title="AFI">
               </a>
            </p>
         </div>
...
<form name="frmSearch" method="post" action="index">
   ...
   <div class="afi-blog pt-md-5 pb-md-5" style="position: relative;">
      <div class="container">
         <div class="row">
            <div class="headers">
               <h2 class="wow fadeInLeft">News | Blogs</h2>
                         ...
                         if(is_numeric($k)) {
                           ...
                           <div class="col-md-4">
                            <div class="ptrs poters">
                              <img src="../<?php echo IMG_PATH; ?>blogs/<?php echo $result[$k]["blogImg"]; ?>" class="img-fluid" style="height: 204px !important; border-radius: 5px;">
                              <div class="ptrs-cont">
                                 <p><?php echo substr($result[$k]["blogTitle"],0,50); ?></p>
                                 <p><?php echo date("d-M-Y", strtotime($result[$k]["createdOn"]));  ?></p>
                                 <p class="read"><a href="find?q=<?php echo $result[$k]["urlSlug"]; ?>">Read More</a></p>
                     ...
                     if(!empty($result)) {
                        foreach($result as $k=>$v) {
                           if(is_numeric($k)) {
                              ...
                              <div class="col-md-4">
                                 <div class="blog-box">
                                    <img src="../<?php echo IMG_PATH; ?>blogs/<?php echo $result[$k]["blogImg"]; ?>" class="img-fluid">
                                    <div class="blck">
                                       <p class="dates"><?php echo date("d-F-Y", strtotime($result[$k]["createdOn"]));  ?></p>
                                       <p><?php echo $result[$k]["autherName"]; ?></p>
                                    </div>
                                    <h4><?php echo $result[$k]["blogTitle"]; ?></h4>
                                    <p><?php echo substr($result[$k]["blogContent"],0,200); ?></p>
                                    <p class="read"><a href="find?q=<?php echo $result[$k]["urlSlug"]; ?>">Read More</a></p>
                                 </div>
                              </div>
                              <?php
...
<div class="register pt-md-3 pb-md-3">
   <div class="container">
      <div class="row">
         <div class="heads">
            <h2 class="wow fadeInLeft">Join Ayurveda Federation of India</h2>
      ...
      <div class="row pt-md-3 jits">
         ...
         <div class="col-md-4">
            ...
            <div class="afis">
               <a href="membership.php" target="_blank"><img src="../img/afi3.png" class="img-fluid"></a>
            </div>
         </div>
      </div>
   </div>
