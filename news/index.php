   ...
   foreach($_POST["search"] as $k=>$v){
      if(!empty($v)) {
         ...
         switch($k) {
            case "name":
            $name = $v;
            $queryCondition .= "newsTitle LIKE '" . $v . "%'";
            break;
            case "code":
            $code = $v;
...
$orderby = " ORDER BY news_id_pk desc"; 
$sql = "SELECT * FROM tbl_news " . $queryCondition;
$href = 'news/index.php';              
$perPage = 9; 
$page = 1;
if(isset($_POST['page'])){
   ...
   <div class="header" id="myHeader">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <ul class="navbar-nav ml-auto">
            <?php 
            $query = "SELECT * FROM tbl_menu WHERE parent_ID = '0' order by forCommuniteSorting asc";
            $runQuery = $connect->query($query);
...
<form name="frmSearch" method="post" action="index">
   <div class="middle-header p-md-3 mhds">    
     <div class="middle-right wow fadeInRight" >
       <ul>
        <li class="wow fadeInLeft"><a href="">Latest News  </a></li>
  ...
  <div class="afi-news pt-md-5 pb-md-5" style="position: relative;">
    <div class="container">
     <div class="row">
      <div class="headers">
         <h2 class="wow fadeInLeft">News Gallery</h2> 
          ...
          if(is_numeric($k)) {
            ...
            <div class="col-md-4">
             <div class="ptrs poters">
              <img src="../<?php echo IMG_PATH; ?>news/<?php echo $result[$k]["newImage"]; ?>" class="img-fluid">
              <div class="ptrs-cont">
               <h4><?php echo $result[$k]["newsTitle"]; ?></h4>
